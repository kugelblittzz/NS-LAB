...
main (int argc, char *argv[])
{
  ...
  //
  LogComponentEnable ("l4q1m", LOG_LEVEL_INFO);
  ...
  NodeContainer c0 = NodeContainer (c.Get (0), c.Get (2));//point to point
  ...
  //
    AsciiTraceHelper ascii;
  csma.EnableAsciiAll (ascii.CreateFileStream ("l4q1m.tr"));
